...
We verify the incorrectness of Zhang \etal's attack: their complexities are far too optimistic and several critical parameters are wrongly evaluated due to their incorrect implementations.
...
\subsection{The Keystream Generation Procedure of A5/1}
...
\begin{aligned}
  z^t=&\vec{R1}^{t+1}[18]\oplus \vec{R2}^{t+1}[21]\oplus \vec{R3}^{t+1}[22]\\
